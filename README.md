...
####NOTE: To simulate a different test-case you need to re-run "make <test-case name>" to generate the corresponding pmem.mem file and re-run the synthesis step (step 10 in [Creating a Vivado Project for VAPE]) in Vivado. 
